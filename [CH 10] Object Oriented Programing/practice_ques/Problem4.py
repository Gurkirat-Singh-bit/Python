# Problem 4) Add a static method in problem 2, to greet the user with hello.
...
class calculator:                                            # defining a class
    ...
    @staticmethod                                            # use of static method

    def greet():                                             # static functions

        print("hi there ")                                   # that does not require a self parameter
...
a.greet()                                                    # calling to static function